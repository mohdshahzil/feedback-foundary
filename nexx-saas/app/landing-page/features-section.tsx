...
const features = [
  ...
  {
    title: 'Customizable',
    description: 'Customize Feedback Foundary to fit your needs and preferences.',
    icon: 'icon-2',
  },
  {
    title: 'Analytics',
  ...
  {
    title: 'Secure',
    description: 'Your data is safe and secure with Feedback Foundary.',
  },
  {
    title: 'Scalable',
    description: 'Grow your business with Feedback Foundary as you scale.',
  },
  {
    title: 'Fast Support',
